...
import type { BoardRow, LiveState, Task } from "../../src/shared";
import { liveStateFromStatus, mapSessionToCard, mapTaskToDto } from "../../src/server/dto";
...
describe("mapTaskToDto", () => {
  it("carries BoardV3 task metadata", () => {
    ...
    expect(mapTaskToDto(task)).toEqual(task);
  });
});
