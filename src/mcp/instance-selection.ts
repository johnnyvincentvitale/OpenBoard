...
function selectionEnv(options: BoardClientOptions): EnvLike {
  return {
    OPENCODE_BOARD_URL: options.env?.OPENCODE_BOARD_URL ?? process.env.OPENCODE_BOARD_URL,
    OPENBOARD_API_TOKEN: options.env?.OPENBOARD_API_TOKEN ?? process.env.OPENBOARD_API_TOKEN,
    OPENBOARD_INSTANCE_NAME: (options.env as EnvLike | undefined)?.OPENBOARD_INSTANCE_NAME ?? process.env.OPENBOARD_INSTANCE_NAME,
    OPENBOARD_INSTANCE_WORKSPACE: (options.env as EnvLike | undefined)?.OPENBOARD_INSTANCE_WORKSPACE ?? process.env.OPENBOARD_INSTANCE_WORKSPACE,
    OPENBOARD_INSTANCE_DB_PATH: (options.env as EnvLike | undefined)?.OPENBOARD_INSTANCE_DB_PATH ?? process.env.OPENBOARD_INSTANCE_DB_PATH,
    OPENBOARD_SELECTION_SOURCE: (options.env as EnvLike | undefined)?.OPENBOARD_SELECTION_SOURCE ?? process.env.OPENBOARD_SELECTION_SOURCE,
  };
}
